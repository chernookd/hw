...
public class Task15Test {
    ...
    @Test
    public void getMoreHeavyAnimalAmongAnimalLowerThanKTest() {
        ...
        assertThat(Task15.getTotalWeightAnimalsThatFromKToLYearsOld(testList, 5, 7)).isEqualTo(4);
        assertThat(Task15.getTotalWeightAnimalsThatFromKToLYearsOld(testList, 1, 5)).isEqualTo(73);
        assertThat(Task15.getTotalWeightAnimalsThatFromKToLYearsOld(testList, 0, 0)).isEqualTo(0);
    }
}
