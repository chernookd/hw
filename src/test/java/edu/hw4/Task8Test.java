...
public class Task8Test {
    ...
    public void getMoreHeavyAnimalAmongAnimalLowerThanKTest()
    {
        ...
        assertThat(Task8.getMoreHeavyAnimalAmongAnimalLowerThanK(testList, 100)).isEqualTo(seventh);
        assertThat(Task8.getMoreHeavyAnimalAmongAnimalLowerThanK(testList, 5)).isEqualTo(sixth);
        assertThat(Task8.getMoreHeavyAnimalAmongAnimalLowerThanK(testList, 1)).isEqualTo(null);
    }
}
